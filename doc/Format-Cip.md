...
E.g.: `P = INIT ∨ C 0 ∨ C 1 ∨ ... ∨ C n` where `INIT` is the allowed initial states and `C 0` to `C n` are the Craig interpolants of each step.
...
The following QBF-checks proove the certificate is valid:
